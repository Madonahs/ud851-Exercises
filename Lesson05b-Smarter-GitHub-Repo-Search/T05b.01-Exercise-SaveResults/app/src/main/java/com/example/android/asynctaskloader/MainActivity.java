...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            mUrlDisplayTextView.setText(key);
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        String displayURl = mUrlDisplayTextView.getText().toString();
        outState.putString(key,displayURl);

        String jsonDisplay = mSearchResultsTextView.getText().toString();
        outState.putString(rawJson,jsonDisplay);
    }
